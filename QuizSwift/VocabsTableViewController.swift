//
//  VocabsTableViewController.swift
//  QuizSwift
//
//  Created by Keita Suzuki on 2017/08/18.
...
class VocabsTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
